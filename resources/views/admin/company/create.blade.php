        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4>{{ __('Company Registration Form') }}</h4>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('company.store') }}">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="website" type="text" class="form-control @error('website') is-invalid @enderror" name="website" value="{{ old('website') }}" autocomplete="website" autofocus placeholder="Enter Website">
